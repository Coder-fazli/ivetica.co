...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: seo.metaDescription || "Insights on influencer marketing, UGC production, content strategy, and social media growth from the Lvetica team.",
    openGraph: {
      title: seo.metaTitle || "Blog — Lvetica",
      description: seo.metaDescription || "Insights on influencer marketing, UGC, and social media growth.",
      url: "/blog",
    },
  };
}
...
export default async function BlogPage() {
  ...
  const popular = allPosts.slice(0, 2);
    ...
    <div className="mil-wrapper" id="top">
      ...
      <div className="mil-content">
        <div id="swupMain" className="mil-main-transition">
                ...
                <div className="row">
                  {popular.map((post) => (
                    <div key={post._id} className="col-lg-6">
                      <Link href={`/blog/${post.slug || post._id}`} className="mil-blog-card mil-mb-60">
                        ...
                        <div className="mil-post-descr">
                          <div className="mil-labels mil-up mil-mb-30">
                            ...
                            <div className="mil-label mil-upper">{formatDate(post.createdAt)}</div>
                          </div>
          ...
          {/* all posts — horizontal cards */}
          {rest.length > 0 && (
            <section id={popular.length === 0 ? "blog" : undefined}>
              <div className="container mil-p-120-120">
                <div className="row align-items-center mil-mb-30">
                  <div className="col-lg-6 mil-mb-30">
                    <h3 className="mil-up">All Publications:</h3>
                  </div>
                </div>
                <div className="row">
                  {rest.map((post) => (
                    <div key={post._id} className="col-lg-12">
                      <Link href={`/blog/${post.slug || post._id}`} className="mil-blog-card mil-blog-card-hori mil-more mil-mb-60">
                        <div className="mil-cover-frame mil-up">
                          {post.coverImage && <img src={post.coverImage} alt={post.title} />}
                        </div>
                        <div className="mil-post-descr">
          ...
          {allPosts.length === 0 && (
            <section>
              <div className="container mil-p-120-120">
                <p className="mil-up" style={{ opacity: 0.4 }}>No posts published yet.</p>
              </div>
            </section>
          )}
